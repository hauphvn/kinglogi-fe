...
const Footer = () => {
    ...
    const bottom = useTranslations('FooterBottom');
    return (
        <footer className={'bg-primary'}>
            <div className={'flex justify-between flex-wrap p-10 flex-auto gap-x-4'}>
                <div className={'flex flex-1 flex-row flex-wrap'}>
                    ...
                    <p className={'text-highlight text-[13px]'}>
                        ...
                        hoạt động theo GCN ĐKDN số 0109301679 do Sở KH&ĐT TP Hà Nội cấp ngày 11/08/2020 và Giấy phép
                        KDVT số
                        ...
                        <div className={'flex gap-x-2 flex-wrap h-[100px]'}>
                            ...
                            <Link target={'_blank'} href={'https://www.vietnamairlines.com/vn/vi/home'}
                                ...
                                <Image fill objectFit={'contain'}
                                       src={'/images/vietnam-airlines-vector-logo-2022(1).png'}
                                       alt={'logo'}/>
                            </Link>
            ...
            <div className={'bg-primaryDark h-[40px] text-white text-[14px] flex items-center justify-center'}>{bottom('title')}</div>
        </footer>
    );
};
