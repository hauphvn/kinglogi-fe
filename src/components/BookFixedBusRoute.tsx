...
const BookFixedBusRoute = () => {
    ...
    return (
        <div
            ...
            <SectionTopPage title={'ĐẶT XE TUYẾN CỐ ĐỊNH NGAY'}/>
            <div className={'font-light text-[15px] pb-3 tracking-[0.8px] max-w-[400px]'}>
                Xin vui lòng chọn hành trình cho chuyến đi của quý khách.
                Điểm đón trả khách theo hành trình này được mặc định là trung tâm hành chính của địa phương.
            </div>
            ...
            <div className={'w-[80%]'}>
                    ...
                    <div className={'flex text-[12px] px-5 border-primaryDarkOpacityBorder bg-primaryDarkOpacityBackground text-primaryLight py-1 mt-4 rounded border '} style={{wordWrap: 'break-word'}}>
                        ...
                        <span>
                            Phụ thu ngoài giờ đối với các chuyến xe có thời gian đón, trả trong khung giờ từ sau 22h00 đến
                        trước 06h00 sáng có thể được áp dụng.
                        Vui lòng liên hệ với <span className={'font-bold'}>KING Logi</span> nếu cần thêm chi tiết.
                        </span>
                    </div>
            </div>
        </div>
...
export default BookFixedBusRoute;
